...
public class BanquewsLocator extends org.apache.axis.client.Service implements soapws.Banquews {
    ...
    private java.lang.String BanqueServicePort_address = "http://localhost:8090/";
    ...
    public soapws.BanqueService getBanqueServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public soapws.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soapws.BanqueServicePortBindingStub _stub = new soapws.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soapws.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                soapws.BanqueServicePortBindingStub _stub = new soapws.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapws/", "banquews");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapws/", "BanqueServicePort"));
        }
